...
import { NavigationBar, RouteButtonGroup } from '@/components';
            ...
            <footer className="flex fixed bottom-4 left-0 w-full z-50 overflow-scroll scrollbar-none py-2 px-2 ">
              <NavigationBar
                ...
                outerContainerClassName={cn(
                  'bg-beige text-dark-green flex items-center justify-center z-10 overflow-hidden active:bg-slate-500 active:duration-300 shadow-sm shadow-dark-green active:opacity-100 rounded-[20px] px-4 py-2 cursor-pointer transition'
                )}
                innerContainerClassName="flex items-center justify-center p-2"
                buttonTextClassName={cn(
                  'text-[16px] whitespace-nowrap self-center text-dark-green font-kurale',
                  {

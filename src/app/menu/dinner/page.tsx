...
const Dinner = () => {
  ...
  return (
    <div className="flex w-full flex-col p-4 justify-center items-center">
      <div className="flex flex-col h-[95vh] w-full rounded-2xl  bg-green-300 justify-center items-center">
        ...
        <div className="text-[50px] font-serif font-extrabold">Dinner</div>
      </div>
    </div>
  );
};
